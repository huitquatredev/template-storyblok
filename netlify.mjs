...
async function main() {
  ...
  if (!storyblokSpaceId) {
    console.error(`
Error: STORYBLOK_SPACEID environment variable is not set.
...
Example: STORYBLOK_SPACEID=123456
    `);
...
# Configure STORYBLOK_SPACEID in your environment variables.
...
[images]
  # Dynamically set from STORYBLOK_SPACEID environment variable
